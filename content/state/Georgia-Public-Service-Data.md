---
state: Georgia
title: Public Service Data
seo_title: Public Service Data Lifeline Provider in Georgia
phone: 478-847-4111
...
# How to get Public Service Data Lifeline assistance program in Georgia 
...
## Ways to Qualify for Public Service Data Lifeline in Georgia 

### Based on Your Income

You can get Public Service Data Lifeline if your income is 135% or less than the Federal Poverty Guidelines (see the table below). The guideline is based on your household size and state.
...
### Eligibility Requirements for Public Service Data Lifeline Services in Georgia

To qualify for a free government phone through Public Service Data, you must meet specific eligibility criteria set by the Lifeline program. These criteria are designed to ensure that the benefits reach those who need them the most. Here are the primary ways to qualify:
...
Some states have different income guidelines and additional documentation requirements. It is essential to check the specific requirements for your state by visiting the Universal Service Administrative Company (USAC) website or the Public Service Data website.
...
By meeting these eligibility criteria, you may qualify for Public Service Data Lifeline services, including a free cell phone and monthly service.

## Documentation Requirements for Application

To apply for a free government phone through Public Service Data, you must provide specific documentation to verify your eligibility. Here are the essential documents you need:
...
By providing the necessary documentation, you can streamline your application process and ensure that you meet the eligibility requirements for Public Service Data's free government phone service.
