---
state: Washington
title: Declaration Networks (NeuBeam)
seo_title: Declaration Networks (NeuBeam) Lifeline Provider in Washington
phone: 877-811-1133
...
## Ways to Qualify for Declaration Networks (NeuBeam) Lifeline in Washington 

### Based on Your Income

You can get Declaration Networks (NeuBeam) Lifeline if your income is 135% or less than the Federal Poverty Guidelines (see the table below). The guideline is based on your household size and state.
...
### Eligibility Requirements for Declaration Networks (NeuBeam) Lifeline Services in Washington

To qualify for a free government phone through Declaration Networks (NeuBeam), you must meet specific eligibility criteria set by the Lifeline program. These criteria are designed to ensure that the benefits reach those who need them the most. Here are the primary ways to qualify:
...
Some states have different income guidelines and additional documentation requirements. It is essential to check the specific requirements for your state by visiting the Universal Service Administrative Company (USAC) website or the Declaration Networks (NeuBeam) website.
...
By meeting these eligibility criteria, you may qualify for Declaration Networks (NeuBeam) Lifeline services, including a free cell phone and monthly service.

## Documentation Requirements for Application

To apply for a free government phone through Declaration Networks (NeuBeam), you must provide specific documentation to verify your eligibility. Here are the essential documents you need:
...
By providing the necessary documentation, you can streamline your application process and ensure that you meet the eligibility requirements for Declaration Networks (NeuBeam)'s free government phone service.
