...
state: Maryland
title: Simple Fiber
seo_title: Simple Fiber Lifeline Provider in Maryland
phone: 410-844-4159
Service: Home Internet
0ACP: 
Discounted: 
CompanyURL: https://www.simple-fiber.com/
---


# How to get Simple Fiber Lifeline assistance program in Maryland 

Simple Fiber is part of a Lifeline which is a federal program dedicated to making phone and internet service more affordable for low-income households. This benefit provides eligible consumers with a monthly discount of up to $9.25. Consumers living on Tribal lands are eligible for an enhanced discount of up to $34.25 per month.
...
## Ways to Qualify for Simple Fiber Lifeline in Maryland 

### Based on Your Income

You can get Simple Fiber Lifeline if your income is 135% or less than the Federal Poverty Guidelines (see the table below). The guideline is based on your household size and state.
...
### Eligibility Requirements for Simple Fiber Lifeline Services in Maryland

To qualify for a free government phone through Simple Fiber, you must meet specific eligibility criteria set by the Lifeline program. These criteria are designed to ensure that the benefits reach those who need them the most. Here are the primary ways to qualify:
...
Some states have different income guidelines and additional documentation requirements. It is essential to check the specific requirements for your state by visiting the Universal Service Administrative Company (USAC) website or the Simple Fiber website.
...
By meeting these eligibility criteria, you may qualify for Simple Fiber Lifeline services, including a free cell phone and monthly service.

## Documentation Requirements for Application

To apply for a free government phone through Simple Fiber, you must provide specific documentation to verify your eligibility. Here are the essential documents you need:
...
By providing the necessary documentation, you can streamline your application process and ensure that you meet the eligibility requirements for Simple Fiber's free government phone service.
