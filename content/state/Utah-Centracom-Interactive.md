---
state: Utah
title: Centracom Interactive
seo_title: Centracom Interactive Lifeline Provider in Utah
phone: 800-427-8449
Service: Home Internet
0ACP: 
Discounted: 
CompanyURL: https://centracom.com/home
---


# How to get Centracom Interactive Lifeline assistance program in Utah 

Centracom Interactive is part of a Lifeline which is a federal program dedicated to making phone and internet service more affordable for low-income households. This benefit provides eligible consumers with a monthly discount of up to $9.25. Consumers living on Tribal lands are eligible for an enhanced discount of up to $34.25 per month.
...
## Ways to Qualify for Centracom Interactive Lifeline in Utah 

### Based on Your Income

You can get Centracom Interactive Lifeline if your income is 135% or less than the Federal Poverty Guidelines (see the table below). The guideline is based on your household size and state.
...
### Eligibility Requirements for Centracom Interactive Lifeline Services in Utah

To qualify for a free government phone through Centracom Interactive, you must meet specific eligibility criteria set by the Lifeline program. These criteria are designed to ensure that the benefits reach those who need them the most. Here are the primary ways to qualify:
...
Some states have different income guidelines and additional documentation requirements. It is essential to check the specific requirements for your state by visiting the Universal Service Administrative Company (USAC) website or the Centracom Interactive website.
...
By meeting these eligibility criteria, you may qualify for Centracom Interactive Lifeline services, including a free cell phone and monthly service.

## Documentation Requirements for Application

To apply for a free government phone through Centracom Interactive, you must provide specific documentation to verify your eligibility. Here are the essential documents you need:
...
By providing the necessary documentation, you can streamline your application process and ensure that you meet the eligibility requirements for Centracom Interactive's free government phone service.
