...
subheader:
     greeting: Contact President Joe Biden
     description: Joseph Robinette Biden, Jr. was born in Scranton, Pennsylvania, the first of four children of Catherine Eugenia Finnegan Biden and Joseph Robinette Biden, Sr. In 1953, the Biden family moved to Claymont, Delaware.
description: Here you will find contact information for President Joe Biden, including the email address, phone number, and mailing address.
image: joe-biden.jpeg
video: 
url: /whitehouse/joe-biden/
weight: 1
layout: course_home
