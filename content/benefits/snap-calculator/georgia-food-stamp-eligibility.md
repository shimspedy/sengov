...
title: "georgia"
seo_title: "georgia Food Stamp Eligibility Calculator 2024 "
subheader:
     greeting: georgia Food Stamp Eligibility Calculator 2024
...
imageurl: 
imagedir: root
url: /snap-calculator/georgia-food-stamp-eligibility
weight: 1
layout: calculator
...
### SNAP Eligibility in Georgia

To qualify for SNAP benefits in Georgia, households must meet three eligibility tests: the Gross Income, Net Income, and Asset tests. Depending on whether a household member is 60 or older or has a disability, your household may be exempt from one or more of these tests.

Georgia has expanded eligibility beyond the standard federal SNAP requirements, so you might see different financial eligibility requirements on other websites.
...
There is no asset limit in Georgia. If the household has a member who is 60 or older or has a disability and did not meet the Gross Income test, there is an asset limit of $4,250.
...
- Households can only receive one utility allowance. If a household qualifies for multiple allowances, choose the highest allowance.
  - Heating and Cooling: $412
  - Basic Utility Allowance: $349
  - Phone: $42
